...
class ProcessController extends Controller
{
	public function index(Request $request)
	{
		...
		$booking = new Booking();
		$booking->customer_id = $customer_id;    //$customer->id;
		...
		foreach ($request->user_cart as $key => $service) {
			...
			$bookingdetail->booking_id = $lastest_booking_id;  //$letest_booking_id ;
			...
			$bookingdetail->booking_notes =  $customerData['bookingNotes'];
			$bookingdetail->price = $request->total;
			date_default_timezone_set("Asia/Dhaka");
