            ...
            <div class="main-menu-wrapper">
                ...
                <ul class="main-nav align-items-lg-center">
                    ...
                    <li>
                        ...
                        <li><a href="providers.html">Become a Provider</a></li>
                                            ...
                                            <div class="single-demo active">
                                                <div class="demo-img">
                                                    <a href="index.html"><img
                                                            src="{{ asset('assets_front') }}/img/home-01.jpg"
                                            ...
                                            <div class="single-demo">
                                                <div class="demo-img">
                                                    <a href="index-2.html"><img
                                                            src="{{ asset('assets_front') }}/img/home-02.jpg"
                                                            class="img-fluid" alt="img"></a>
                                                </div>
                                                <div class="demo-info">
                                            ...
                                            <div class="single-demo">
                                                <div class="demo-img">
                                                    <a href="index-3.html"><img
                                                            src="{{ asset('assets_front') }}/img/home-3.jpg"
                                                            class="img-fluid" alt="img"></a>
                                                </div>
                                                <div class="demo-info">
                                            ...
                                            <div class="single-demo">
                                                <div class="demo-img">
                                                    <a href="index-4.html"><img
                                                            src="{{ asset('assets_front') }}/img/home-04.jpg"
                                                            class="img-fluid" alt="img"></a>
                                                </div>
                                                <div class="demo-info">
                                            ...
                                            <div class="single-demo">
                                                <div class="demo-img">
                                                    <a href="index-5.html"><img
                                                            src="{{ asset('assets_front') }}/img/home-05.jpg"
                                                            class="img-fluid" alt="img"></a>
                                                </div>
                                                <div class="demo-info">
                                            ...
                                            <div class="single-demo">
                                                <div class="demo-img">
                                                    <a href="index-6.html"><img
                                                            src="{{ asset('assets_front') }}/img/home-06.jpg"
                                                            class="img-fluid" alt="img"></a>
                                                </div>
                                                <div class="demo-info">
                                            ...
                                            <div class="single-demo">
                                                <div class="demo-img">
                                                    <a href="index-7.html"><img
                                                            src="{{ asset('assets_front') }}/img/home-09.jpg"
                                                            class="img-fluid" alt="img"></a>
                                                </div>
                                                <div class="demo-info">
                                            ...
                                            <div class="single-demo">
                                                <div class="demo-img">
                                                    <a href="index-8.html"><img
                                                            src="{{ asset('assets_front') }}/img/home-08.jpg"
                                                            class="img-fluid" alt="img"></a>
                                                </div>
                                                <div class="demo-info">
                                            ...
                                            <div class="single-demo">
                                                <div class="demo-img">
                                                    <a href="index-9.html"><img
                                                            src="{{ asset('assets_front') }}/img/home-10.jpg"
                                                            class="img-fluid" alt="img"></a>
                                                </div>
                                                <div class="demo-info">
                                            ...
                                            <div class="single-demo">
                                                <div class="demo-img">
                                                    <a href="index-10.html"><img
                                                            src="{{ asset('assets_front') }}/img/home-07.jpg"
                                                            class="img-fluid" alt="img"></a>
                                                </div>
                                                <div class="demo-info">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0);" data-bs-toggle="modal"
                            data-bs-target="#provider">Become a Provider</a>
                    </li>
                    <li class="nav-item">
