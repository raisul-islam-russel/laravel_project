...
<body>
				...
				<div class="main-menu-wrapper">
					...
					<ul class="main-nav align-items-lg-center">
										...
										<div class="row">
											<div class="col-lg-2">
												<div class="single-demo active">
													<div class="demo-img">
														<a href="index.html"><img src="{{asset('assets_front')}}/img/home-01.jpg"
											...
											<div class="col-lg-2">
												<div class="single-demo">
													<div class="demo-img">
														<a href="index-2.html"><img src="{{asset('assets_front')}}/img/home-02.jpg"
																class="img-fluid" alt="img"></a>
													</div>
													<div class="demo-info">
											...
											<div class="col-lg-2">
												<div class="single-demo">
													<div class="demo-img">
														<a href="index-3.html"><img src="{{asset('assets_front')}}/img/home-3.jpg"
																class="img-fluid" alt="img"></a>
													</div>
													<div class="demo-info">
											...
											<div class="col-lg-2">
												<div class="single-demo">
													<div class="demo-img">
														<a href="index-4.html"><img src="{{asset('assets_front')}}/img/home-04.jpg"
																class="img-fluid" alt="img"></a>
													</div>
													<div class="demo-info">
											...
											<div class="col-lg-2">
												<div class="single-demo">
													<div class="demo-img">
														<a href="index-5.html"><img src="{{asset('assets_front')}}/img/home-05.jpg"
																class="img-fluid" alt="img"></a>
													</div>
													<div class="demo-info">
											...
											<div class="col-lg-2">
												<div class="single-demo">
													<div class="demo-img">
														<a href="index-6.html"><img src="{{asset('assets_front')}}/img/home-06.jpg"
																class="img-fluid" alt="img"></a>
													</div>
													<div class="demo-info">
											...
											<div class="col-lg-2">
												<div class="single-demo">
													<div class="demo-img">
														<a href="index-7.html"><img src="{{asset('assets_front')}}/img/home-09.jpg"
																class="img-fluid" alt="img"></a>
													</div>
													<div class="demo-info">
											...
											<div class="col-lg-2">
												<div class="single-demo">
													<div class="demo-img">
														<a href="index-8.html"><img src="{{asset('assets_front')}}/img/home-08.jpg"
																class="img-fluid" alt="img"></a>
													</div>
													<div class="demo-info">
											...
											<div class="col-lg-2">
												<div class="single-demo">
													<div class="demo-img">
														<a href="index-9.html"><img src="{{asset('assets_front')}}/img/home-10.jpg"
																class="img-fluid" alt="img"></a>
													</div>
													<div class="demo-info">
											...
											<div class="col-lg-2">
												<div class="single-demo">
													<div class="demo-img">
														<a href="index-10.html"><img src="{{asset('assets_front')}}/img/home-07.jpg"
																class="img-fluid" alt="img"></a>
													</div>
													<div class="demo-info">
						...
						<li class="nav-item has-submenu">
							<a class="nav-link" href="javascript:void(0);">Pages<i class="fas fa-chevron-down"></i></a>
							<ul class="submenu">
						...
						<li class="nav-item">
							<a class="nav-link" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#provider">Become a Provider</a>
						</li>
						<li class="nav-item">
		...
		<div class="hero-content position-relative overflow-hidden">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
							...
							<div class="banner-form bg-white border mb-3">
								...
								<img src="{{asset('assets_front')}}/img/bg/bg-06.svg" alt="img" class="shape-06 round-animate">
							</div>
					...
					<div class="banner-img wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
						<img src="{{asset('assets_front')}}/img/banner.png" alt="img" class="img-fluid animation-float">
					</div>
				</div>
			</div>
			<div class="hero-image">
				...
				<div class="d-inline-flex bg-white p-2 rounded align-items-center shape-02 floating-x">
					<span class="me-2"><img src="{{asset('assets_front')}}/img/icons/tick-banner.svg" alt=""></span>
		...
		<div class="container">
			...
			<div
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="{{asset('assets_front')}}/img/icons/category-01.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="{{asset('assets_front')}}/img/icons/category-02.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="{{asset('assets_front')}}/img/icons/category-13.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="{{asset('assets_front')}}/img/icons/category-04.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="{{asset('assets_front')}}/img/icons/category-05.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="{{asset('assets_front')}}/img/icons/category-06.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="{{asset('assets_front')}}/img/icons/category-07.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="{{asset('assets_front')}}/img/icons/category-08.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="{{asset('assets_front')}}/img/icons/category-09.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="{{asset('assets_front')}}/img/icons/category-10.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="{{asset('assets_front')}}/img/icons/category-11.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="{{asset('assets_front')}}/img/icons/category-12.svg" class="img-fluid" alt="img">
						</div>
						...
						<div class="img-slider owl-carousel nav-center">
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-01.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-02.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-03.jpg" class="img-fluid" alt="img">
								</a>
							</div>
						</div>
				...
				<div class="service-item wow fadeInUp" data-wow-delay="0.2s">
					<div class="service-img">
						<div class="img-slider owl-carousel nav-center">
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-04.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-05.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-06.jpg" class="img-fluid" alt="img">
								</a>
							</div>
						</div>
						<div class="trend-icon">
				...
				<div class="service-item wow fadeInUp" data-wow-delay="0.2s">
					<div class="service-img">
						<div class="img-slider owl-carousel nav-center">
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-07.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-08.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-09.jpg" class="img-fluid" alt="img">
								</a>
							</div>
						</div>
						<div class="fav-item">
				...
				<div class="service-item wow fadeInUp" data-wow-delay="0.2s">
					<div class="service-img">
						<div class="img-slider owl-carousel nav-center">
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-10.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-11.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-12.jpg" class="img-fluid" alt="img">
								</a>
							</div>
						</div>
						<div class="fav-item">
				...
				<div class="service-item wow fadeInUp" data-wow-delay="0.2s">
					<div class="service-img">
						<div class="img-slider owl-carousel nav-center">
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-16.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-17.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-18.jpg" class="img-fluid" alt="img">
								</a>
							</div>
						</div>
						<div class="fav-item">
						...
						<div class="service-item wow fadeInUp" data-wow-delay="0.2s">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-19.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
									...
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-15.jpg" class="img-fluid" alt="img">
										</a>
									</div>
								</div>
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-02.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
						...
						<div class="service-item wow fadeInUp" data-wow-delay="0.2s">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-20.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-03.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
						...
						<div class="service-item wow fadeInUp" data-wow-delay="0.2s">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-21.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-04.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
						...
						<div class="service-item wow fadeInUp" data-wow-delay="0.2s">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-22.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-05.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
						...
						<div class="service-item wow fadeInUp" data-wow-delay="0.2s">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-13.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-14.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-01.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
					...
					<div class="feature-slider owl-carousel nav-center">
						<div class="service-item">
							<div class="service-img">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-11.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
						...
						<div class="service-item">
							<div class="service-img">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-12.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
						...
						<div class="service-item">
							<div class="service-img">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-17.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
						...
						<div class="service-item">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-54.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-08.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
						...
						<div class="service-item">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-56.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-14.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
						...
						<div class="service-item">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-62.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-16.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
						...
						<div class="service-item">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-59.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-19.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
					...
					<div class="feature-slider owl-carousel nav-center">
						...
						<div class="service-item">
							<div class="service-img">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-06.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
						...
						<div class="service-item">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-63.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
						...
						<div class="service-item">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-60.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-15.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
						...
						<div class="service-item">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-55.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-13.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
						...
						<div class="service-item">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-51.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
								...
								<div class="fav-item d-flex align-items-center justify-content-between w-100">
									<a href="javascript:void(0);" class="avatar avatar-md">
										<img src="{{asset('assets_front')}}/img/profiles/avatar-18.jpg" class="rounded-circle" alt="User">
									</a>
									<a href="javascript:void(0);" class="fav-icon">
										<i class="ti ti-heart"></i>
									</a>
						...
						<div class="service-item">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-58.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
						...
						<div class="service-item">
							<div class="service-img">
								<div class="img-slider owl-carousel nav-center">
									<div class="slide-images">
										<a href="service-details.html">
											<img src="{{asset('assets_front')}}/img/services/service-61.jpg" class="img-fluid" alt="img">
										</a>
									</div>
									<div class="slide-images">
										<a href="service-details.html">
	...
	<section class="section pt-0">
		<div class="container">
			<div class="work-section bg-black m-0">
				...
				<div class="work-bg1">
					<img src="{{asset('assets_front')}}/img/bg/work-bg-01.svg" class="img-fluid" alt="img">
				</div>
				<div class="work-bg2">
					<img src="{{asset('assets_front')}}/img/bg/work-bg-02.svg" class="img-fluid" alt="img">
				</div>
			</div>
		</div>
	</section>
				...
				<div class="service-item">
					<div class="service-img">
						<div class="img-slider owl-carousel nav-center">
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-24.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
					...
					<div class="service-content">
						<div class="d-flex align-items-center justify-content-between mb-2">
							<a href="provider-details.html" class="d-flex align-items-center mb-2 service-pro-info">
								<span class="avatar avatar-sm me-2">
									<img src="{{asset('assets_front')}}/img/profiles/avatar-17.jpg" alt="img"
										class="img-fluid rounded-circle">
								</span>
				...
				<div class="service-item">
					<div class="service-img">
						<div class="img-slider owl-carousel nav-center">
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-25.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
					...
					<div class="service-content">
						<div class="d-flex align-items-center justify-content-between mb-2">
							<a href="provider-details.html" class="d-flex align-items-center mb-2 service-pro-info">
								<span class="avatar avatar-sm me-2">
									<img src="{{asset('assets_front')}}/img/profiles/avatar-16.jpg" alt="img"
										class="img-fluid rounded-circle">
								</span>
				...
				<div class="service-item">
					<div class="service-img">
						<div class="img-slider owl-carousel nav-center">
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-50.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
					...
					<div class="service-content">
						<div class="d-flex align-items-center justify-content-between mb-2">
							<a href="provider-details.html" class="d-flex align-items-center mb-2 service-pro-info">
								<span class="avatar avatar-sm me-2">
									<img src="{{asset('assets_front')}}/img/profiles/avatar-06.jpg" alt="img"
										class="img-fluid rounded-circle">
								</span>
				...
				<div class="service-item">
					<div class="service-img">
						<div class="img-slider owl-carousel nav-center">
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-47.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-48.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="{{asset('assets_front')}}/img/services/service-49.jpg" class="img-fluid" alt="img">
								</a>
							</div>
						</div>
						<div class="fav-item">
					...
					<div class="service-content">
						<div class="d-flex align-items-center justify-content-between mb-2">
							<a href="provider-details.html" class="d-flex align-items-center mb-2 service-pro-info">
								<span class="avatar avatar-sm me-2">
									<img src="{{asset('assets_front')}}/img/profiles/avatar-09.jpg" alt="img"
										class="img-fluid rounded-circle">
								</span>
				...
				<div class="service-item">
					...
					<div class="service-content">
						<div class="d-flex align-items-center justify-content-between mb-2">
							<a href="provider-details.html" class="d-flex align-items-center mb-2 service-pro-info">
								<span class="avatar avatar-sm me-2">
									<img src="{{asset('assets_front')}}/img/profiles/avatar-25.jpg" alt="img"
										class="img-fluid rounded-circle">
								</span>
				...
				<div class="row gx-0">
						...
						<div class="provider-item flex-fill">
							<div class="d-flex align-items-center">
								<a href="provider-details.html" class="avatar avatar-xl me-2">
									<img src="{{asset('assets_front')}}/img/profiles/avatar-18.jpg" alt="img" class="rounded-circle">
								</a>
								<div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 d-flex">
						<div class="provider-item flex-fill">
							<div class="d-flex align-items-center">
								<a href="provider-details.html" class="avatar avatar-xl me-2">
									<img src="{{asset('assets_front')}}/img/profiles/avatar-07.jpg" alt="img" class="rounded-circle">
								</a>
								<div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 d-flex">
						<div class="provider-item flex-fill">
							<div class="d-flex align-items-center">
								<a href="provider-details.html" class="avatar avatar-xl me-2">
									<img src="{{asset('assets_front')}}/img/profiles/avatar-08.jpg" alt="img" class="rounded-circle">
								</a>
								<div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 d-flex">
						<div class="provider-item flex-fill">
							<div class="d-flex align-items-center">
								<a href="provider-details.html" class="avatar avatar-xl me-2">
									<img src="{{asset('assets_front')}}/img/profiles/avatar-09.jpg" alt="img" class="rounded-circle">
								</a>
								<div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 d-flex">
						<div class="provider-item flex-fill">
							<div class="d-flex align-items-center">
								<a href="provider-details.html" class="avatar avatar-xl me-2">
									<img src="{{asset('assets_front')}}/img/profiles/avatar-19.jpg" alt="img" class="rounded-circle">
								</a>
								<div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 d-flex">
						<div class="provider-item flex-fill">
							<div class="d-flex align-items-center">
								<a href="provider-details.html" class="avatar avatar-xl me-2">
									<img src="{{asset('assets_front')}}/img/profiles/avatar-11.jpg" alt="img" class="rounded-circle">
								</a>
								<div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 d-flex">
						<div class="provider-item flex-fill">
							<div class="d-flex align-items-center">
								<a href="provider-details.html" class="avatar avatar-xl me-2">
									<img src="{{asset('assets_front')}}/img/profiles/avatar-12.jpg" alt="img" class="rounded-circle">
								</a>
								<div>
			...
			<div class="tab-content">
					...
					<div class="row g-4">
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-05.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Laser Tattoo Removal</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-06.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Surgical Excision</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-07.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Saline Tattoo Removal</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-08.jpg" alt="img" class="img-fluid">
				...
				<div class="tab-pane fade" id="rate-furniture">
					<div class="row g-4">
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-09.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Home Furniture Assembly</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-10.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Office Furniture Assembly</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-11.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Fitness Equipment Assembly</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-12.jpg" alt="img" class="img-fluid">
				...
				<div class="tab-pane fade show active" id="rate-electrical">
					<div class="row g-4">
						<div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.2s">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-01.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Wiring and rewiring</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.4s">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-02.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Ceiling fan installation</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.6s">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-03.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Faulty wiring repair</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.8s">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-04.jpg" alt="img" class="img-fluid">
				...
				<div class="tab-pane fade" id="rate-construction">
					<div class="row g-4">
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-13.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Residential Construction</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-14.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Roofing Services</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-15.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Commercial Construction</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-16.jpg" alt="img" class="img-fluid">
				...
				<div class="tab-pane fade" id="rate-man">
					<div class="row g-4">
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-17.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Local Moves</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-18.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Furniture Delivery</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-19.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">House Clearance</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-20.jpg" alt="img" class="img-fluid">
				...
				<div class="tab-pane fade" id="rate-plumbing">
					<div class="row g-4">
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-21.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Water Filtration</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-22.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Emergency Plumbing Repairs</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-23.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Drain Cleaning</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="{{asset('assets_front')}}/img/services/rated-service-24.jpg" alt="img" class="img-fluid">
		...
		<div class="container">
			...
			<div class="testimonial-slider owl-carousel nav-center">
					...
					<div class="d-flex align-items-center justify-content-between">
						<div class="d-flex align-items-center overflow-hidden">
							<span class="avatar avatar-lg flex-shrink-0">
								<img src="{{asset('assets_front')}}/img/profiles/avatar-14.jpg" class="img-fluid rounded-circle" alt="img">
							</span>
				...
				<div class="testimonial-item wow fadeInUp" data-wow-delay="0.2s">
					...
					<div class="d-flex align-items-center justify-content-between">
						<div class="d-flex align-items-center overflow-hidden">
							<span class="avatar avatar-lg flex-shrink-0">
								<img src="{{asset('assets_front')}}/img/profiles/avatar-15.jpg" class="img-fluid rounded-circle" alt="img">
							</span>
				...
				<div class="testimonial-item wow fadeInUp" data-wow-delay="0.2s">
					...
					<div class="d-flex align-items-center justify-content-between">
						<div class="d-flex align-items-center overflow-hidden">
							<span class="avatar avatar-lg flex-shrink-0">
								<img src="{{asset('assets_front')}}/img/profiles/avatar-13.jpg" class="img-fluid rounded-circle" alt="img">
							</span>
				...
				<div class="testimonial-item wow fadeInUp" data-wow-delay="0.2s">
					...
					<div class="d-flex align-items-center justify-content-between">
						<div class="d-flex align-items-center overflow-hidden">
							<span class="avatar avatar-lg flex-shrink-0">
								<img src="{{asset('assets_front')}}/img/profiles/avatar-12.jpg" class="img-fluid rounded-circle" alt="img">
							</span>
			...
			<div class="text-center wow fadeInUp" data-wow-delay="0.2s">
				...
				<p>
					...
					<img src="{{asset('assets_front')}}/img/icons/star-01.svg" class="img-fluid" alt="img">
					<img src="{{asset('assets_front')}}/img/icons/star-01.svg" class="img-fluid" alt="img">
					<img src="{{asset('assets_front')}}/img/icons/star-01.svg" class="img-fluid" alt="img">
					<img src="{{asset('assets_front')}}/img/icons/star-01.svg" class="img-fluid" alt="img">
					<img src="{{asset('assets_front')}}/img/icons/star-01.svg" class="img-fluid" alt="img">
		...
		<div class="container">
			...
			<div class="blog-slider owl-carousel nav-center nav-center">
				<div class="blog-item wow fadeInUp" data-wow-delay="0.2s">
					<div class="blog-img">
						<a href="blog-details.html">
							<img src="{{asset('assets_front')}}/img/blogs/blog-01.jpg" class="img-fluid" alt="img">
						</a>
					</div>
				...
				<div class="blog-item wow fadeInUp" data-wow-delay="0.2s">
					<div class="blog-img">
						<a href="blog-details.html">
							<img src="{{asset('assets_front')}}/img/blogs/blog-02.jpg" class="img-fluid" alt="img">
						</a>
					</div>
					<div class="blog-content">
						<p class="fs-14 fw-meium text-gray-9 d-inline-flex align-items-center mb-2">Admin<i
				...
				<div class="blog-item wow fadeInUp" data-wow-delay="0.2s">
					<div class="blog-img">
						<a href="blog-details.html">
							<img src="{{asset('assets_front')}}/img/blogs/blog-03.jpg" class="img-fluid" alt="img">
						</a>
					</div>
					<div class="blog-content">
						<p class="fs-14 fw-meium text-gray-9 d-inline-flex align-items-center mb-2">Admin<i
				...
				<div class="blog-item wow fadeInUp" data-wow-delay="0.2s">
					<div class="blog-img">
						<a href="blog-details.html">
							<img src="{{asset('assets_front')}}/img/blogs/blog-04.jpg" class="img-fluid" alt="img">
						</a>
					</div>
					<div class="blog-content">
						<p class="fs-14 fw-meium text-gray-9 d-inline-flex align-items-center mb-2">Admin<i
				...
				<div class="blog-item wow fadeInUp" data-wow-delay="0.2s">
					<div class="blog-img">
						<a href="blog-details.html">
							<img src="{{asset('assets_front')}}/img/blogs/blog-05.jpg" class="img-fluid" alt="img">
						</a>
					</div>
					<div class="blog-content">
						<p class="fs-14 fw-meium text-gray-9 d-inline-flex align-items-center mb-2">Admin<i
			...
			<div class="row align-items-center bg-01">
				...
				<div class="col-md-6 text-md-end wow fadeInUp" data-wow-delay="0.2s">
					<div class="business-img">
						<img src="{{asset('assets_front')}}/img/business.jpg" class="img-fluid" alt="img">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				...
				<div class="d-flex align-items-center justify-content-between flex-wrap mt-3">
					<ul class="social-icon mb-3">
						...
						<li>
							<a href="javascript:void(0);"><img src="{{asset('assets_front')}}/img/icons/instagram.svg" class="img"
									alt="icon"></a>
						</li>
						<li>
							<a href="javascript:void(0);"><img src="{{asset('assets_front')}}/img/icons/twitter.svg" class="img"
									alt="icon"></a>
						</li>
						<li>
							<a href="javascript:void(0);"><img src="{{asset('assets_front')}}/img/icons/whatsapp.svg" class="img"
									alt="icon"></a>
						</li>
						<li>
							<a href="javascript:void(0);"><img src="{{asset('assets_front')}}/img/icons/youtube.svg" class="img"
									alt="icon"></a>
						</li>
						<li>
							<a href="javascript:void(0);"><img src="{{asset('assets_front')}}/img/icons/linkedin.svg" class="img"
									alt="icon"></a>
						</li>
					</ul>
					<div class="d-flex align-items-center">
							...
							<div class="mb-2">
								...
								<div class="category-badge">
									<span class="badge d-inline-flex align-items-center mb-2 me-2"><img
											src="{{asset('assets_front')}}/img/icons/service-icon-01.svg" alt="icon"
											class="me-2">Construction</span>
									<span class="badge d-inline-flex align-items-center mb-2 me-2"><img
											src="{{asset('assets_front')}}/img/icons/service-icon-02.svg" alt="icon"
											class="me-2">Removals</span>
									<span class="badge d-inline-flex align-items-center mb-2 me-2"><img
											src="{{asset('assets_front')}}/img/icons/service-icon-03.svg" alt="icon" class="me-2">Furniture
										Assembly</span>
									<span class="badge d-inline-flex align-items-center mb-2 me-2"><img
											src="{{asset('assets_front')}}/img/icons/service-icon-04.svg" alt="icon"
											class="me-2">Electrical</span>
									<span class="badge d-inline-flex align-items-center mb-2"><img
											src="{{asset('assets_front')}}/img/icons/service-icon-05.svg" alt="icon" class="me-2">Computer
										Service</span>
								</div>
							</div>
						</div>
						...
						<div class="d-flex align-items-center mb-3">
							<a href="javascript:void(0);"
								class="btn btn-light flex-fill d-flex align-items-center justify-content-center me-3"><img
									src="{{asset('assets_front')}}/img/icons/google-icon.svg" class="me-2" alt="Img">Google</a>
							<a href="javascript:void(0);"
								class="btn btn-light flex-fill d-flex align-items-center justify-content-center"><img
									src="{{asset('assets_front')}}/img/icons/fb-icon.svg" class="me-2" alt="Img">Facebook</a>
						</div>
				...
				<div class="modal-body p-4">
					<form action="#" class="digit-group">
						<div class="text-center mb-3">
							...
							<p class="fs-14">OTP sent to your Email Address ending ******<a href="https://truelysell.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="63070c0623061b020e130f064d000c0e">[email&#160;protected]</a></p>
						</div>
	...
	<!-- Jquery JS -->
	<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="{{asset('assets_front')}}/js/jquery-3.7.1.min.js" type="89bc0c1d1fbca1b88f685693-text/javascript"></script>
...
<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="89bc0c1d1fbca1b88f685693-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"90bf47f0eaf3786e","version":"2025.1.0","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>
