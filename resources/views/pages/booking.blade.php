															...
															<div class="dropdown-menu dropdown-sm p-3">
																...
																<div class="d-flex align-items-center p-2 bg-light rounded mb-3">
																	<span class="avatar avatar-lg">
																		<img src="{{ asset('assets_front') }}/img/services/addservice-05.jpg" alt="img">
																	</span>
																	<div class="ms-2">
												...
												<div class="row g-3">
														...
														<div class="card location-card mb-0">
															<div class="card-body p-3 text-center">
																<div class="trend-icon">
																	<span class="bg-info">
																		<img src="{{ asset('assets_front') }}/img/icons/loc-icon.svg" alt="icon">
																	</span>
																</div>
																<span class="avatar avatar-lg mx-auto mb-2">
																	<img src="{{ asset('assets_front') }}/img/icons/service-01.svg" alt="img">
																</span>
													...
													<div class="col-lg-4 col-md-6">
														<div class="card location-card mb-0">
															<div class="card-body p-3 text-center">
																...
																<span class="avatar avatar-lg mx-auto mb-2">
																	<img src="{{ asset('assets_front') }}/img/icons/service-02.svg" alt="img">
																</span>
																<h6 class="mb-2 fw-medium">Lighting Services - California Shop</h6>
																<p class="d-flex align-items-center justify-content-center mb-2"><i class="ti ti-map-pin-check me-1"></i>1052 Edsel Road LA</p>
																<div class="d-flex align-items-center justify-content-between border-top pt-2">
													...
													<div class="col-lg-4 col-md-6">
														<div class="card location-card mb-0">
															<div class="card-body p-3 text-center">
																<span class="avatar avatar-lg mx-auto mb-2">
																	<img src="{{ asset('assets_front') }}/img/icons/service-03.svg" alt="img">
																</span>
													...
													<div class="col-lg-4 col-md-6">
														<div class="card location-card mb-0">
															<div class="card-body p-3 text-center">
																<span class="avatar avatar-lg mx-auto mb-2">
																	<img src="{{ asset('assets_front') }}/img/icons/service-04.svg" alt="img">
																</span>
													...
													<div class="col-lg-4 col-md-6">
														<div class="card location-card mb-0">
															<div class="card-body p-3 text-center">
																<span class="avatar avatar-lg mx-auto mb-2">
																	<img src="{{ asset('assets_front') }}/img/icons/service-05.svg" alt="img">
																</span>
												...
												<div class="row g-3">
													...
													<div class="col-lg-4 col-md-6">
														<div class="card staff-card mb-0">
															<div class="card-body p-3 text-center">
																<span class="avatar avatar-lg mx-auto mb-2">
																	<img src="{{ asset('assets_front') }}/img/profiles/avatar-14.jpg" alt="img">
																</span>
													...
													<div class="col-lg-4 col-md-6">
														<div class="card staff-card mb-0">
															<div class="card-body p-3 text-center">
																<span class="avatar avatar-lg mx-auto mb-2">
																	<img src="{{ asset('assets_front') }}/img/profiles/avatar-26.jpg" alt="img">
																</span>
													...
													<div class="col-lg-4 col-md-6">
														<div class="card staff-card mb-0">
															<div class="card-body p-3 text-center">
																<span class="avatar avatar-lg mx-auto mb-2">
																	<img src="{{ asset('assets_front') }}/img/profiles/avatar-22.jpg" alt="img">
																</span>
													...
													<div class="col-lg-4 col-md-6">
														<div class="card staff-card mb-0">
															<div class="card-body p-3 text-center">
																<span class="avatar avatar-lg mx-auto mb-2">
																	<img src="{{ asset('assets_front') }}/img/profiles/avatar-04.jpg" alt="img">
																</span>
													...
													<div class="col-lg-4 col-md-6">
														<div class="card staff-card mb-0">
															<div class="card-body p-3 text-center">
																<span class="avatar avatar-lg mx-auto mb-2">
																	<img src="{{ asset('assets_front') }}/img/profiles/avatar-24.jpg" alt="img">
																</span>
												...
												<div class="row g-3">
													<div class="col-md-6">
														<div class="select-item d-flex align-items-center justify-content-between flex-wrap border p-2 pb-0 mb-0">
															<div class="d-flex align-items-center pb-2">
																<span class="avatar avatar-lg">
																	<img src="{{ asset('assets_front') }}/img/services/addservice-01.jpg" alt="img" class="br-5">
																</span>
																<div class="ms-2">
													...
													<div class="col-md-6">
														<div class="select-item d-flex align-items-center justify-content-between flex-wrap border p-2 pb-0 mb-0">
															<div class="d-flex align-items-center pb-2">
																<span class="avatar avatar-lg">
																	<img src="{{ asset('assets_front') }}/img/services/addservice-02.jpg" alt="img" class="br-5">
																</span>
																<div class="ms-2">
													...
													<div class="col-md-6">
														<div class="select-item d-flex align-items-center justify-content-between flex-wrap border p-2 pb-0 mb-0">
															<div class="d-flex align-items-center pb-2">
																<span class="avatar avatar-lg">
																	<img src="{{ asset('assets_front') }}/img/services/addservice-03.jpg" alt="img" class="br-5">
																</span>
																<div class="ms-2">
													...
													<div class="col-md-6">
														<div class="select-item d-flex align-items-center justify-content-between flex-wrap border p-2 pb-0 mb-0">
															<div class="d-flex align-items-center pb-2">
																<span class="avatar avatar-lg">
																	<img src="{{ asset('assets_front') }}/img/services/addservice-04.jpg" alt="img" class="br-5">
																</span>
																<div class="ms-2">
													...
													<div class="col-md-6">
														<div class="select-item d-flex align-items-center justify-content-between flex-wrap border p-2 pb-0 mb-0">
															<div class="d-flex align-items-center pb-2">
																<span class="avatar avatar-lg">
																	<img src="{{ asset('assets_front') }}/img/services/addservice-05.jpg" alt="img" class="br-5">
																</span>
																<div class="ms-2">
												...
												<div class="row g-3">
													<div class="col-md-6">	
														...
														<div class="payment-item d-flex align-items-center justify-content-between mb-2">
															...
															<div>
																<img src="{{ asset('assets_front') }}/img/icons/payment1.svg" alt="payment">
															</div>
														</div>
														<div class="payment-item d-flex align-items-center justify-content-between mb-2">
															<div class="form-check d-flex align-items-center ps-0">
															...
															<div>
																<img src="{{ asset('assets_front') }}/img/icons/payment2.svg" alt="payment">
															</div>
														</div>
														<div class="payment-item d-flex align-items-center justify-content-between mb-2">
															<div class="form-check d-flex align-items-center ps-0">
															...
															<div>
																<img src="{{ asset('assets_front') }}/img/icons/razor-pay.svg" alt="payment">
															</div>
														</div>
														<div class="payment-item d-flex align-items-center justify-content-between mb-2">
															<div class="form-check d-flex align-items-center ps-0">
															...
															<div>
																<img src="{{ asset('assets_front') }}/img/icons/pay-solution.svg" alt="payment">
															</div>
														</div>
														<div class="payment-item d-flex align-items-center justify-content-between mb-0">
															...
															<div>
																<img src="{{ asset('assets_front') }}/img/icons/square.svg" alt="payment">
															</div>
														</div>
													</div>
													<div class="col-md-6">		
